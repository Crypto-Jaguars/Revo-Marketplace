...
import {
  ...
  farmDetailsSchema,
  accountSetupSchema,
  farmerSubscriptionSchema,
  type FarmerSubscriptionData,
} from './schema';
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(val) =>
                form.setValue('farmingMethod', val as FormValues['farmingMethod'])
              }
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="agreeToTerms" className="text-sm">
              {t('agreePrefix')}{' '}
              <a href="/terms-of-use" className="underline" target="_blank" rel="noreferrer">
                {t('terms')}
              </a>{' '}
              {t('and')}{' '}
