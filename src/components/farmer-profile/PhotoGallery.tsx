...
const PhotoGallery = ({ isOwner = false }) => {
  ...
  return (
    <section className="bg-white p-6 mb-8 rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {photos.map((photo) => (
          <div key={photo.id} className="aspect-square rounded-lg overflow-hidden bg-gray-100 hover:shadow-md transition-shadow cursor-pointer">
            <img 
              src={photo.url} 
              alt={photo.alt}
