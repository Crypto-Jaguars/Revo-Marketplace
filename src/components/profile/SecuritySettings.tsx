...
import { Shield, Key, Smartphone, Eye, EyeOff, AlertTriangle, CheckCircle, Clock, Trash2, Download } from "lucide-react"
        ...
        <CardContent>
          <div className="space-y-4">
            {sessions.map((session) => (
              <div key={session.id} className="p-4 bg-gray-100 rounded-lg">
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-1">
                      <p className="text-gray-900 font-semibold">{session.device}</p>
                      {session.current && <Badge className="bg-green-600 text-white">Current</Badge>}
                    </div>
                    <div className="text-sm text-gray-500">
        ...
        <CardContent>
          <div className="space-y-4">
            {securityLogs.map((log) => (
              <div key={log.id} className="p-4 bg-gray-100 rounded-lg">
                <div className="flex items-center justify-between">
