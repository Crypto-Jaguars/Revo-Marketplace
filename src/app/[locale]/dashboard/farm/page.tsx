  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <h2 id="weather-title" className="text-xl font-semibold mb-4">
            {t('weather.title')}
          </h2>
        ...
        >
          ...
          <div className="space-y-4">
            <div
              ...
              role="group"
              aria-label={t('stats.totalCrops')}
            >
              <span className="text-gray-600">{t('stats.totalCrops')}</span>
              <span className="font-semibold" aria-label={`24 ${t('stats.totalCrops')}`}>
                24
              </span>
            </div>
            <div
              className="flex justify-between items-center"
              role="group"
              aria-label={t('stats.activeFields')}
            >
              <span className="text-gray-600">{t('stats.activeFields')}</span>
              <span className="font-semibold" aria-label={`8 ${t('stats.activeFields')}`}>
                8
              </span>
            </div>
            <div
              className="flex justify-between items-center"
              role="group"
              aria-label={t('stats.harvestReady')}
            >
              <span className="text-gray-600">{t('stats.harvestReady')}</span>
              <span
                className="font-semibold text-green-600"
                aria-label={`3 ${t('stats.harvestReady')}`}
              >
                3
              </span>
            </div>
        ...
        >
          <h2 id="tasks-title" className="text-xl font-semibold mb-4">
            {t('tasks.title')}
          </h2>
      ...
      {/* Recent Activity */}
      <section className="mt-8 bg-white rounded-lg shadow-md p-6" aria-labelledby="activity-title">
