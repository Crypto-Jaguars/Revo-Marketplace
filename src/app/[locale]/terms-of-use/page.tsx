      ...
      <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-300 leading-relaxed">
                  These Terms of Use govern your use of the Revolutionary Farmers marketplace
                  platform. By using our services, you agree to comply with these terms and all
          ...
          <CardContent>
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-gray-300">
                  Attempting to gain unauthorized access to user accounts
                </span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
                <span className="text-gray-300">
                  Uploading viruses, malware, or other harmful content
                </span>
              </li>
              <li className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-gray-300">
                Revolutionary Farmers and its licensors own all intellectual property rights in the
                platform, including:
              </p>
              <ul className="space-y-2">
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-gray-300">
                    Software, source code, and technical systems
                  </span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-green-500 rounded-full mt-2 flex-shrink-0"></div>
        ...
        <Card className="mt-8 bg-white/10 backdrop-blur-sm border-white/20">
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-gray-300">
                Revolutionary Farmers is provided &quot;as is&quot; without warranties of any kind.
              ...
              <p className="text-gray-300 text-sm">
                Use of the platform is at your own risk. We are not responsible for the quality,
                safety, or legality of products sold by farmers.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mt-8 bg-white/10 backdrop-blur-sm border-white/20">
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-gray-300">
                To the maximum extent permitted by law, Revolutionary Farmers shall not be liable
                for:
              </p>
              <ul className="space-y-2">
                <li className="flex items-start space-x-3">
        ...
        <Card className="mt-8 bg-white/10 backdrop-blur-sm border-white/20">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <p className="text-gray-300 text-sm">
                Upon termination, your right to use the platform ceases immediately. Some provisions
